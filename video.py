...
async def on_member_join(member): 
    ...
    await client.send_message(chat_bem_vindo, "{} *Bem vindo(a) ao servidor* __**The Light**__. *Leia as {} e se registre em {} :tada::hugging: !*".format(member.mention, mencao_regras, mencao_registro))
